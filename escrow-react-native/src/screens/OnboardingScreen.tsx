        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            >
              ...
              >
                {(() => {
                  ...
                  return (
                    <Icon
                      style="w-10 h-10 sm:w-12 sm:h-12"
            ...
            <motion.h2
              ...
              style="mb-3 sm:mb-4 dark:text-white text-xl sm:text-2xl"
            >
            ...
            <motion.p
              ...
              style="text-gray-600 dark:text-gray-400 mb-6 sm:mb-8 text-sm sm:text-base px-2"
            >
