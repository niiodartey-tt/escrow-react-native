            ...
            >
              <Card style={`p-6 shadow-md ${isDark ? 'bg-gray-800 border-gray-700' : ''}`}>
                ...
                <View style="space-y-4">
                  ...
                  <View>
                    <Label style={isDark ? 'text-gray-300' : ''}>Last Name *</Label>
                    <Input
              ...
              <Card style={`p-6 shadow-md ${isDark ? 'bg-gray-800 border-gray-700' : ''}`}>
                ...
                <View style="space-y-4">
                  ...
                  <View style="grid grid-cols-2 gap-3">
                    ...
                    <View>
                      <Label style={isDark ? 'text-gray-300' : ''}>State *</Label>
                      <Input
                        value={kycData.state}
                  ...
                  <View style="grid grid-cols-2 gap-3">
                    ...
                    <View>
                      <Label style={isDark ? 'text-gray-300' : ''}>Country *</Label>
                      <Select 
            ...
            >
              <Card style={`p-6 shadow-md ${isDark ? 'bg-gray-800 border-gray-700' : ''}`}>
                ...
                <View style="space-y-4">
                  ...
                  <View>
                    <Label style={isDark ? 'text-gray-300' : ''}>ID Number *</Label>
                    <Input
                  ...
                  <View>
                    <Label style={isDark ? 'text-gray-300' : ''}>ID Expiry Date *</Label>
                    <Input
                      type="date"
                ...
                <View style="space-y-4">
                  ...
                  <View>
                    ...
                    <motion.label
                      ...
                      whileTap={{ scale: 0.99 }}
                      style={`mt-2 flex flex-col items-center justify-center p-6 border-2 border-dashed cursor-pointer transition-colors ${
                  ...
                  {/* ID Back Photo */}
                  <View>
                    <Label style={isDark ? 'text-gray-300' : ''}>ID Back Photo (Optional)</Label>
                    <motion.label
                      whileHover={{ scale: 1.01 }}
                      whileTap={{ scale: 0.99 }}
                      style={`mt-2 flex flex-col items-center justify-center p-6 border-2 border-dashed cursor-pointer transition-colors ${
                  ...
                  {/* Selfie Photo */}
                  <View>
                    <Label style={isDark ? 'text-gray-300' : ''}>Selfie with ID *</Label>
                    <motion.label
                      whileHover={{ scale: 1.01 }}
                      whileTap={{ scale: 0.99 }}
                      style={`mt-2 flex flex-col items-center justify-center p-6 border-2 border-dashed cursor-pointer transition-colors ${
                  ...
                  {/* Address Proof */}
                  <View>
                    <Label style={isDark ? 'text-gray-300' : ''}>Proof of Address (Optional)</Label>
                    <motion.label
                      whileHover={{ scale: 1.01 }}
                      whileTap={{ scale: 0.99 }}
                      style={`mt-2 flex flex-col items-center justify-center p-6 border-2 border-dashed cursor-pointer transition-colors ${
